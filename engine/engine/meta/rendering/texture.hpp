...
REFLECT_INLINE(texture_info)
{
    rttr::registration::enumeration<texture_format>("texture_format")(
        rttr::value("BC1", texture_format::BC1),
        rttr::value("BC2", texture_format::BC2),
        rttr::value("BC3", texture_format::BC3),
        rttr::value("BC4", texture_format::BC4),
        rttr::value("BC5", texture_format::BC5),
        rttr::value("BC6H", texture_format::BC6H),
        rttr::value("BC7", texture_format::BC7),
        rttr::value("ETC1", texture_format::ETC1),
        rttr::value("ETC2", texture_format::ETC2),
        rttr::value("ETC2A", texture_format::ETC2A),
        rttr::value("ETC2A1", texture_format::ETC2A1),
        rttr::value("PTC12", texture_format::PTC12),
        rttr::value("PTC14", texture_format::PTC14),
        rttr::value("PTC12A", texture_format::PTC12A),
        rttr::value("PTC14A", texture_format::PTC14A),
        rttr::value("PTC22", texture_format::PTC22),
        rttr::value("PTC24", texture_format::PTC24),
