...
REFLECT(light)
{
    ...
    rttr::registration::class_<light::point>("point")
        ...
        .property("fovx_adjust", &light::point::fov_x_adjust)(rttr::metadata("pretty_name", "FovX Adjust"),
                                                              rttr::metadata("min", -20.0f),
                                                              rttr::metadata("max", 20.0f),
                                                              rttr::metadata("step", 0.0001f))
        .property("fovy_adjust", &light::point::fov_y_adjust)(rttr::metadata("pretty_name", "FovY Adjust"),
                                                              rttr::metadata("min", -20.0f),
                                                              rttr::metadata("max", 20.0f),
                                                              rttr::metadata("step", 0.0001f))
        .property("stencil_pack", &light::point::stencil_pack)(rttr::metadata("pretty_name", "Stencil Pack"));

    rttr::registration::class_<light::directional>("directional")
        .property("splits", &light::directional::num_splits)(rttr::metadata("pretty_name", "Splits"),
                                                             rttr::metadata("min", 1),
                                                             rttr::metadata("max", 4))
        .property("distribution",
                  &light::directional::split_distribution)(rttr::metadata("pretty_name", "Distribution"),
                                                           rttr::metadata("min", 0.0f),
                                                           rttr::metadata("max", 1.0f),
                                                           rttr::metadata("step", 0.001f))
        .property("stabilize", &light::directional::stabilize)(rttr::metadata("pretty_name", "Stabilize"));
    ...
    rttr::registration::enumeration<depth_type>("depth_type")(rttr::value("invz", depth_type::invz),
                                                              rttr::value("linear", depth_type::linear));
    rttr::registration::enumeration<shadow_type>("shadow_type")(rttr::value("hard", shadow_type::hard),
    ...
    rttr::registration::class_<light>("light")
        ...
        .property("spot_data", &light::spot_data)(rttr::metadata("pretty_name", "Spot"))
        .property("point_data", &light::point_data)(rttr::metadata("pretty_name", "Point"))
        .property("directional", &light::directional_data)(rttr::metadata("pretty_name", "Directional"));
