...
public:
    ...
    public:
        triangle_t generate() const
        {
            ...
            if(odd_ == 0)
            {
                triangle.vertices[0] = shapeEdge.vertices[0] + pathEdge.vertices[0] * mesh_->shape_vertex_count_;
                triangle.vertices[1] = shapeEdge.vertices[1] + pathEdge.vertices[1] * mesh_->shape_vertex_count_;
                triangle.vertices[2] = shapeEdge.vertices[0] + pathEdge.vertices[1] * mesh_->shape_vertex_count_;
            }
            else
            {
                triangle.vertices[0] = shapeEdge.vertices[0] + pathEdge.vertices[0] * mesh_->shape_vertex_count_;
                triangle.vertices[1] = shapeEdge.vertices[1] + pathEdge.vertices[0] * mesh_->shape_vertex_count_;
                triangle.vertices[2] = shapeEdge.vertices[1] + pathEdge.vertices[1] * mesh_->shape_vertex_count_;
            }
