...
parametric_shape_t::edges_t::edges_t(const parametric_shape_t& shape) : shape_{&shape}, i_{0}
{
}
...
parametric_shape_t::vertices_t::vertices_t(const parametric_shape_t& shape) : shape_{&shape}, i_{0}
{
}
...
parametric_shape_t::parametric_shape_t(const std::function<shape_vertex_t(double)>& eval, int segments) noexcept
    : eval_{std::move(eval)}
    , segments_{segments}
    , delta_{1.0 / segments}
{
