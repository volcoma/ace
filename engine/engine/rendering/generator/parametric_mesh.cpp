...
parametric_mesh_t::triangles_t::triangles_t(const parametric_mesh_t& mesh) : mesh_{&mesh}, i_{0}, even_{false}
{
}
...
parametric_mesh_t::vertices_t::vertices_t(const parametric_mesh_t& mesh) : mesh_{&mesh}, i_{0}
{
}
