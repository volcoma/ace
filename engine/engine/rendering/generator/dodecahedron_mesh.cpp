...
void dodecahedron_mesh_t::triangles_t::next()
{
    ...
    if(triangles_.done())
    {
        ...
        if(!done())
        {
            face_mesh_ = std::make_shared<convex_polygon_mesh_t>(makevertices_t(face_index_), mesh_->segments_);
...
void dodecahedron_mesh_t::vertices_t::next()
{
    ...
    if(vertices_.done())
    {
        ...
        {
            face_mesh_ =
                std::make_shared<convex_polygon_mesh_t>(makevertices_t(face_index_), mesh_->segments_, mesh_->rings_);
