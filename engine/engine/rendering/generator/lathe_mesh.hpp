...
public:
    ...
    private:
        ...
        explicit triangles_t(const lathe_mesh_t& mesh) : mesh_{&mesh}, shape_edges_{mesh.shape_.edges()}, i_{0}
        {
        }
    ...
    private:
        ...
        explicit vertices_t(const lathe_mesh_t& mesh) : mesh_{&mesh}, shape_vertices_{mesh.shape_.vertices()}, i_{0}
        {
        }
...
template<typename shape_t>
lathe_mesh_t<shape_t> lathe(shape_t shape,
