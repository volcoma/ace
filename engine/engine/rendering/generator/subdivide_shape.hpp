...
public:
    ...
    private:
        ...
        explicit edges_t(const subdivide_shape_t& shape) : shape_{&shape}, edges_{shape.shape_.edges()}, i_{0}
        {
        }
    ...
    subdivide_shape_t(shape_t shape) : shape_(std::move(shape)), vertex_cache_{}
    {
