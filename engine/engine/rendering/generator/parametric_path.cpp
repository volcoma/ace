...
parametric_path_t::edges_t::edges_t(const parametric_path_t& path) : path_{&path}, i_{0}
{
}
...
parametric_path_t::vertices_t::vertices_t(const parametric_path_t& path) : path_{&path}, i_{0}
{
}
