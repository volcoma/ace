...
public:
    ...
    private:
        ...
        explicit edges_t(const subdivide_path_t& path) : path_{&path}, edges_{path.path_.edges()}, i_{0}
        {
        }
    ...
    private:
        ...
        explicit vertices_t(const subdivide_path_t& path) : path_{&path}, vertex_index_{0}, edges_{path.path_.edges()}
        {
        }
    ...
    subdivide_path_t(path_t path) : path_(std::move(path)), vertex_cache_{}
    {
