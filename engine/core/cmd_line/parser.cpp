...
parser::cmd_base::cmd_base(const std::string& name, const std::string& alternative,
...
auto parser::parse(const std::vector<std::string>& elements, const unsigned int&, int numberBase)
	-> unsigned int
{
	if(elements.size() != 1)
	{
...
auto parser::parse(const std::vector<std::string>& elements, const unsigned long&, int numberBase)
	-> unsigned long
{
	if(elements.size() != 1)
	{
