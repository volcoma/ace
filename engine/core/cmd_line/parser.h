...
private:
	...
	static auto parse(const std::vector<std::string>& elements, const int& /*unused*/, int numberBase = 0)
		-> int;
	...
	static auto parse(const std::vector<std::string>& elements, const unsigned int& /*unused*/,
					  int numberBase = 0) -> unsigned int;

	static auto parse(const std::vector<std::string>& elements, const unsigned long& /*unused*/,
	...
	template <class T>
	static auto parse(const std::vector<std::string>& elements, const std::vector<T>& /*unused*/)
		-> std::vector<T>
	{
		const T defval = T();
		std::vector<T> values{};
