...
/**/
void vertex_convert(const vertex_layout& _destDecl,
                    void* _destData,
...
/**/
void topology_sort_tri_list(topology_sort _sort,
                            void* _dst,
                            uint32_t _dstSize,
                            const float _dir[3],
                            const float _pos[3],
...
/**/
dynamic_index_buffer_handle create_dynamic_index_buffer(const memory_view* _mem, uint16_t _flags = BGFX_BUFFER_NONE);
...
/**/
dynamic_vertex_buffer_handle create_dynamic_vertex_buffer(uint32_t _num,
                                                          const vertex_layout& _decl,
                                                          uint16_t _flags = BGFX_BUFFER_NONE);

/**/
dynamic_vertex_buffer_handle create_dynamic_vertex_buffer(const memory_view* _mem,
                                                          const vertex_layout& _decl,
                                                          uint16_t _flags = BGFX_BUFFER_NONE);
...
/**/
bool alloc_transient_buffers(transient_vertex_buffer* _tvb,
                             const vertex_layout& _decl,
...
/**/
void calc_texture_size(texture_info& _info,
                       uint16_t _width,
                       uint16_t _height,
                       uint16_t _depth,
                       bool _cubeMap,
...
/**/
texture_handle create_texture(const memory_view* _mem,
                              uint64_t _flags = BGFX_TEXTURE_NONE | BGFX_SAMPLER_NONE,
                              uint8_t _skip = 0,
                              texture_info* _info = nullptr);

/**/
texture_handle create_texture_2d(uint16_t _width,
                                 uint16_t _height,
                                 bool _hasMips,
                                 uint16_t _numLayers,
                                 texture_format _format,
...
/**/
texture_handle create_texture_2d(backbuffer_ratio _ratio,
                                 bool _hasMips,
                                 uint16_t _numLayers,
                                 texture_format _format,
                                 uint64_t _flags = BGFX_TEXTURE_NONE | BGFX_SAMPLER_NONE);
...
/**/
texture_handle create_texture_3d(uint16_t _width,
                                 uint16_t _height,
                                 uint16_t _depth,
                                 bool _hasMips,
                                 texture_format _format,
...
/**/
texture_handle create_texture_cube(uint16_t _size,
                                   bool _hasMips,
                                   uint16_t _numLayers,
                                   texture_format _format,
                                   uint64_t _flags = BGFX_TEXTURE_NONE | BGFX_SAMPLER_NONE,
...
/**/
void update_texture_2d(texture_handle _handle,
                       uint16_t _layer,
                       uint8_t _mip,
                       uint16_t _x,
                       uint16_t _y,
...
/**/
void update_texture_3d(texture_handle _handle,
                       uint8_t _mip,
                       uint16_t _x,
                       uint16_t _y,
                       uint16_t _z,
...
/**/
void update_texture_cube(texture_handle _handle,
                         uint16_t _layer,
                         uint8_t _side,
                         uint8_t _mip,
                         uint16_t _x,
...
/**/
frame_buffer_handle create_frame_buffer(uint16_t _width,
                                        uint16_t _height,
                                        texture_format _format,
                                        uint64_t _textureFlags = BGFX_SAMPLER_U_CLAMP | BGFX_SAMPLER_V_CLAMP);

/**/
frame_buffer_handle create_frame_buffer(backbuffer_ratio _ratio,
                                        texture_format _format,
                                        uint64_t _textureFlags = BGFX_SAMPLER_U_CLAMP | BGFX_SAMPLER_V_CLAMP);

/**/
frame_buffer_handle create_frame_buffer(uint8_t _num, const texture_handle* _handles, bool _destroyTextures = false);

/**/
frame_buffer_handle create_frame_buffer(uint8_t _num, const attachment* _attachment, bool _destroyTextures = false);

/**/
frame_buffer_handle create_frame_buffer(void* _nwh,
                                        uint16_t _width,
                                        uint16_t _height,
...
/**/
void set_view_scissor(view_id _id, uint16_t _x = 0, uint16_t _y = 0, uint16_t _width = 0, uint16_t _height = 0);

/**/
void set_view_clear(view_id _id,
                    uint16_t _flags,
...
/**/
void set_texture(uint8_t _stage, uniform_handle _sampler, texture_handle _handle, uint32_t _flags = UINT32_MAX);
