...
using ImGui_ImplOSPP_RenderWindow_Callback = std::function<void(render_window* window, ImGuiViewport* viewport, void*)>;
using ImGui_ImplOSPP_SwapBuffers_Callback = std::function<void(render_window* window, ImGuiViewport* viewport, void*)>;

IMGUI_IMPL_API auto ImGui_ImplOSPP_Init(render_window* window,
