...
using ImGui_ImplOSPP_RenderWindow_Callback = std::function<void(ace::render_window* window, ImGuiViewport* viewport, void*)>;
using ImGui_ImplOSPP_SwapBuffers_Callback = std::function<void(ace::render_window* window, ImGuiViewport* viewport, void*)>;
