...
//   * linkIcon is a string which encode a "Link" icon, if available in the current font (e.g. linkIcon =
//   ICON_FA_LINK with FontAwesome + IconFontCppHeaders https://github.com/juliettef/IconFontCppHeaders)
