...
using orientation_view_t = entt::view<entt::get_t<orientation>, entt::exclude_t<>>;
using material_view_t = entt::view<entt::get_t<material>, entt::exclude_t<>>;
using mesh_shape_view_t = entt::view<entt::get_t<mesh_shape>, entt::exclude_t<>>;
using paged_mesh_shape_view_t = entt::view<entt::get_t<paged_mesh_shape>, entt::exclude_t<>>;
...
using detect_collision_body_view_t = entt::view<
                                     entt::get_t<AABB, shape_index, position, orientation>,
                                     entt::exclude_t<>>;

using origin_view_t = entt::view<entt::get_t<origin>, entt::exclude_t<>>;
